// ---------------------------------------------------------------------------
// <copyright file="Impersonator.cs" company="Boathill">
...
namespace Common.Extensions
{
    ...
    /// 
    ///		//...
    ///		using ( new Impersonator( "myUsername", "myPassword", "myDomainname" ) )
    ///		{
    ///			//...
    ...
    public class Impersonator : IDisposable
    {
        ...
        private void ImpersonateValidUser(string userName, string password, string domain)
        {
