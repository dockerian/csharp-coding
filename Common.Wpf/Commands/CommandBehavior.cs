...
namespace Common.Wpf.Commands
{
    ...
    public class CommandBehavior
    {
        ...
        /// <summary>
        /// CommandTarget Attached Dependency Property
        /// </summary>
        public static readonly DependencyProperty CommandTargetProperty =
            DependencyProperty.RegisterAttached("CommandTarget", typeof(object), typeof(CommandBehavior),
                new FrameworkPropertyMetadata((object)null,
                    new PropertyChangedCallback(OnCommandTargetChanged)));

        /// <summary>
        /// Gets the CommandTarget property.  
        /// </summary>
        public static object GetCommandTarget(DependencyObject d)
        {
            return (object)d.GetValue(CommandTargetProperty);
        }

        /// <summary>
        /// Sets the CommandTarget property. 
        /// </summary>
        public static void SetCommandTarget(DependencyObject d, object value)
        {
            d.SetValue(CommandTargetProperty, value);
        }
        ...
        {
            CommandBehaviorBinding binding = FetchOrCreateBinding(d);
            binding.CommandTarget = e.NewValue;
        }
        ...
        /// <summary>
        /// CommandEnabled Attached Dependency Property
        /// </summary>
        public static readonly DependencyProperty CommandEnabledProperty =
            DependencyProperty.RegisterAttached("CommandEnabled", typeof(object), typeof(CommandBehavior),
                new FrameworkPropertyMetadata((object)true,
                    new PropertyChangedCallback(OnCommandEnabledChanged)));

        /// <summary>
        /// Gets the CommandEnabled property.  
        /// </summary>
        public static object GetCommandEnabled(DependencyObject d)
        {
            return (object)d.GetValue(CommandEnabledProperty);
        }

        /// <summary>
        /// Sets the CommandEnabled property. 
        /// </summary>
        public static void SetCommandEnabled(DependencyObject d, object value)
        {
            d.SetValue(CommandEnabledProperty, value);
        }
        ...
        {
            CommandBehaviorBinding binding = FetchOrCreateBinding(d);
            binding.CommandEnabled = e.NewValue;
        }
